...
function Welcome() {
  return (
    <main className='bgWelcome w-full h-[80vh] flex space-x-3'>
        <article className={`w-1/2 py-8 px-10  ${roboto.className} space-y-5 mt-16`}>
        ...
        <Link href="/" className={`mt-8 ${roboto.className} px-10 py-5 text-lg font-light btn btn-primary rounded-full`}>
          <h1>Selengkapnya</h1>
        </Link>
        </article>
